...
test-server-integration: ## Server *.integration.spec.ts suite (testcontainers PG — needs a local Docker daemon; NOT part of ci-local, belongs on a dedicated runner group per ENG-1373 5c)
